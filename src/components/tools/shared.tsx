    ...
    <div className="flex h-full flex-col gap-3">
      <div className="flex gap-3" style={{ height: 'calc(100% - 32px)' }}>
        ...
        <div className="flex flex-1 flex-col">
          ...
          <pre className="flex-1 overflow-auto rounded-card border border-line bg-bg-subtle p-3 font-mono text-code text-ink-secondary">
            {output || <span className="text-ink-tertiary">—</span>}
          </pre>
        </div>
      </div>
